...
private:
    HashTable<int, Customer*> m_customers;
    RecordsUnionFind m_recordsUnionFind;
    RankTree<int, Customer*> m_memberCustomers;
    int m_numOfRecords;

    static const int BASIS_SELLING_PRICE = 100;

    void initMemberCustomersExpenses();
};
